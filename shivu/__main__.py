...
async def send_image(update: Update, context: CallbackContext) -> None:
    ...
    multiplier = 100
    weighted_characters = [
        c for c in all_characters if 'rarity' in c and c['rarity'] in rarity_percentages
        for _ in range(int(multiplier * rarity_percentages[c['rarity']]))
    ]
