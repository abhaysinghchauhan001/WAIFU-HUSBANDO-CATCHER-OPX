...
# Function for harem with rarity selection
...
# Handlers registration
 application.add_handler(CommandHandler("hmode", set_hmode))
    ...
    application.add_handler(CallbackQueryHandler(hmode_rarity, pattern='rarity'))
