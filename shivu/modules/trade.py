...
async def gift(client, message):
    ...
    await message.reply_photo(photo=character["img_url"], caption=f' <b>ᴅᴏ Yᴏᴜ Rᴇᴀʟʟʏ Wᴀɴɴᴀ Gɪғᴛ </b><b><code>{character["name"]}</code></b> <b>ᴛᴏ</b> <b>{message.reply_to_message.from_user.mention}</b>  ? ', reply_markup=keyboard)
